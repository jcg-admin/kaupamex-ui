# CLAUDE.md — e-comerce-ui

Submódulo `ui` del monorepo PracticaYoruba (repo GitHub `jcg-admin/e-comerce-ui`).
...
- `../e-comerce/.claude/CLAUDE.md` — contexto/flujo del proyecto (Level 2).
- `../e-comerce/.claude/rules/` — reglas no negociables, entre ellas:
