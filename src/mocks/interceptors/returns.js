 ...
 *   /api/v2/admin/return-requests/       (admin: bandeja, detalle, acciones)
 *
...
const CUSTOMER_PREFIX = '/api/v2/return-requests/';
const ADMIN_PREFIX    = '/api/v2/admin/return-requests/';
